...
대신 명령어를 넣어서 원하는 대로 배치해야 하는 건 다르다. HMI의 경우는 마우스로 끌어다 정해진 디스플레이 안에 배치하고 크기를 조정해서 절대값을 준다면 PyQt의 경우 디스플레이 크기에 따라 조절을 해줘야 하기 때문에 UX신경을 많이 써야 하는 게 느껴졌다.
